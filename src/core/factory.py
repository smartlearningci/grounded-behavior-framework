...
def create_component(section_name: str, section_config: dict[str, Any]) -> ManualProvider:
...
def create_pipeline_components(config: dict[str, Any]) -> dict[str, ManualProvider]:
